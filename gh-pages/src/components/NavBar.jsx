      ...
      <div className="navbar navbar-default">
        <div className="navbar-header" onClick={this.menuClicked}>
          ...
          <div className="navbar-brand">
            <i className="fa fa-cube" /> character-perspective-client
          </div>
        </div>
        ...
        <div
          ...
          <ul className="nav navbar-nav">
            ...
            <li>
              <a href="https://github.com/chad-autry/character-perspective-client">
                <i className="fa fa-github-alt" /> Github
              </a>
            </li>
            <li>
              <a href="https://github.com/chad-autry/character-perspective-client/issues">
